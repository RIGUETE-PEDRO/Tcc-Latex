...
\begin{document}
  ...
  \imprimirdedicatoria
  \input{pre_textuais/declaracaoAutor}
  ...
  \input{textuais/problema_de_pesquisa}
  \input{textuais/objetivos}
  \input{textuais/ref_teorico}
  \input{textuais/Requisitos}
  \input{textuais/modelagem_de_sofware}
  \input{textuais/justificativa}
